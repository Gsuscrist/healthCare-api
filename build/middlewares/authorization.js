...
exports.verifyToken = exports.isDoctor = exports.isAdmin = void 0;
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res, next) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          decode = _jsonwebtoken["default"].verify(token, _config["default"].SECRET_PT);
          req.id = decode.id;
          _context.next = 8;
          return _Patient["default"].findById(req.id, {
            password: 0
          });
        case 8:
          user = _context.sent;
...
var isDoctor = /*#__PURE__*/function () {
  ...
  return function isDoctor(_x4, _x5, _x6) {
